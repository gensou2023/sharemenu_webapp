...
export default function FooterSection() {
  return (
    <footer className="w-full bg-bg-dark py-16 px-6 md:px-10">
      <div className="max-w-[1080px] mx-auto">
        {/* Top Section */}
        <div className="grid grid-cols-1 md:grid-cols-[1.2fr_1fr_1fr] gap-12 mb-12">
          {/* Brand */}
          <div>
        ...
        {/* Footer Bottom */}
        <div className="pt-6 border-t border-white/[.08] flex flex-col sm:flex-row justify-between items-center gap-4">
